...
if (!empty($category) && !empty($subcategory)) {
    ...
    $sql = "SELECT * FROM product WHERE category = ? AND subcategory = ?";
...
<head>
		...
		<title>Royal-carat || Royal Gold & Diamond</title>
		
		<!-- Favicon -->
		<link rel="shortcut icon" type="image/x-icon" href="media/rcl.png">
						...
						<div class="section-container">
							<div class="row">
								...
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 header-center">
									<div class="site-logo">
										<a href="index.php">
											<img width="400" height="79" src="media/royal-carat-logo.png" alt="Royal-carat || Royal Gold & Diamond" />
										</a>
									</div>
								</div>
							...
							<div class="section-container large p-l-r">
								<div class="row">
									<div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 header-left">
										<div class="site-logo">
											<a href="index.html">
												<img  src="media/royal-carat-logo.png" alt="Royal-carat || Royal Gold & Diamond" />
											</a>
										</div>
									</div>

									<div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12 text-center header-center">
										<div class="site-navigation">
											<nav id="main-navigation">
												<ul id="menu-main-menu" class="menu">
													<li class="level-0  current-menu-item">
														<a href="index.php"><span class="menu-item-text">Home</span></a>
														
													</li>
														<li class="level-0 ">
														<a href="all-Jewellery.php"><span class="menu-item-text">All Jewellery</span></a>
														
													</li>
													<li class="level-0 menu-item menu-item-has-children">
														<a href="all-Jewellery.php?category=1"><span class="menu-item-text">Diamond</span></a>
														<ul class="sub-menu">
															<li>
																<a href="all-Jewellery.php?category=1&subcategory=4"><span class="menu-item-text">Earrings</span></a>
												
															</li>
															<li>
																<a href="all-Jewellery.php?category=1&subcategory=5"><span class="menu-item-text">Rings</span></a>
															</li>
															<li>
																<a href="all-Jewellery.php?category=1&subcategory=6"><span class="menu-item-text">Necklaces</span></a>
															</li>
															<li>
																<a href="all-Jewellery.php?category=1&subcategory=7"><span class="menu-item-text">Pendant</span></a>
															</li>
															<li>
																<a href="all-Jewellery.php?category=1&subcategory=8"><span class="menu-item-text">Mangalsutra</span></a>
															</li>
															<li>
																<a href="all-Jewellery.php?category=1&subcategory=9"><span class="menu-item-text">Bracelets and Bangles</span></a>
															</li>
															<li>
																<a href="all-Jewellery.php?category=1&subcategory=10"><span class="menu-item-text">Nosepin</span></a>
															</li>
														</ul>
													</li>
													<li class="level-0 menu-item menu-item-has-children">
														<a href="all-Jewellery.php?category=2"><span class="menu-item-text">Gold</span></a>
														<ul class="sub-menu">
															<li>
																<a href="all-Jewellery.php?category=2&subcategory=11"><span class="menu-item-text">Earrings</span></a>
												
															</li>
															<li>
																<a href="all-Jewellery.php?category=2&subcategory=12"><span class="menu-item-text">Rings</span></a>
															</li>
															<li>
																<a href="all-Jewellery.php?category=2&subcategory=13"><span class="menu-item-text">Necklaces</span></a>
															</li>
															<li>
																<a href="all-Jewellery.php?category=2&subcategory=14"><span class="menu-item-text">Pendant</span></a>
															</li>
															<li>
																<a href="all-Jewellery.php?category=2&subcategory=15"><span class="menu-item-text">Mangalsutra</span></a>
															</li>
															<li>
																<a href="all-Jewellery.php?category=2&subcategory=16"><span class="menu-item-text">Bracelets and Bangles</span></a>
															</li>
															<li>
																<a href="sall-Jewellery.php?category=2&subcategory=17"><span class="menu-item-text">Nosepin</span></a>
															</li>
														</ul>
													</li>
													<li class="level-0 menu-item menu-item-has-children">
														<a href="all-Jewellery.php?category=3"><span class="menu-item-text">Bullions</span></a>
														<ul class="sub-menu">
															<li>
																<a href="all-Jewellery.php?category=3&subcategory=18"><span class="menu-item-text">Gold Coin</span></a>
												
															</li>
															<li>
																<a href="all-Jewellery.php?category=3&subcategory=19"><span class="menu-item-text">Gold Vedhani</span></a>
															</li>
															<li>
																<a href="all-Jewellery.php?category=3&subcategory=20"><span class="menu-item-text">Silver Coin</span></a>
															</li>
														</ul>
													</li>
												</ul>
								...
								<div class="block block-sliders auto-height color-white nav-center">
									<div class="slick-sliders" data-autoplay="true" data-dots="true" data-nav="true" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns1440="1" data-columns="1">
										<div class="item slick-slide">
											<div class="item-content">
												<div class="content-image">
													<img width="1920" height="1080" src="media/slider/b-2.png" alt="Image Slider">
												</div>
												<div class="item-info horizontal-start vertical-middle">
													<div class="content">
														<h2 class="title-slider">Discover a <br>world of jewelry</h2>
														<a class="button-slider button button-white button-outline thick-border" href="all-Jewellery.php">Explore Bestseller</a>
													</div>
												</div>
											</div>
										</div>
										<div class="item slick-slide">
											<div class="item-content">
												<div class="content-image">
													<img width="1920" height="1080" src="media/slider/b-3.png" alt="Image Slider">
												</div>
												<div class="item-info horizontal-start vertical-middle">
													<div class="content">
																...
																<div class="banner-wrapper-infor">
																	<div class="info">
																		<div class="content">
																			...
																			<a class="button" href="all-Jewellery.php">Shop Now</a>						
																		</div>
																	</div>
																</div>
															</div>
																...
																<div class="banner-wrapper-infor text-center">
																	<div class="info">
																		<div class="content">
																			...
																			<a class="button center" href="all-Jewellery.php">Shop Now</a>						
																		</div>
																	</div>
																</div>
															</div>
													...
													<div class="slick-sliders content-category" data-dots="0" data-slidestoscroll="true" data-nav="1" data-columns4="2" data-columns3="3" data-columns2="3" data-columns1="5" data-columns1440="5" data-columns="5">
														<div class="item item-product-cat slick-slide">	
															<div class="item-product-cat-content">
																<a href="all-Jewellery.php">
																	<div class="item-image animation-horizontal">
																		<img width="258" height="258" src="media/diamond-N/diamond N3(1)(1).png" alt="Bracelets">
																	</div>
																</a>			
																<div class="product-cat-content-info">
																	<h2 class="item-title">
																		<a href="all-Jewellery.php">Necklaces</a>
																	</h2>
																</div>
															</div>
														</div>
														<div class="item item-product-cat slick-slide">	
															<div class="item-product-cat-content">
																<a href="all-Jewellery.php">
																	<div class="item-image animation-horizontal">
																		<img width="258" height="258" src="media/gold-R/gold R6.jpg" alt="Charms">
																	</div>
																</a>			
																<div class="product-cat-content-info">
																	<h2 class="item-title">
																		<a href="all-Jewellery.php">Rings</a>
																	</h2>
																</div>
															</div>
														</div>
														<div class="item item-product-cat slick-slide">	
															<div class="item-product-cat-content">
																<a href="all-Jewellery.php">
																	<div class="item-image animation-horizontal">
																		<img width="258"  height="258" src="media/diamond-E/diamond E9.webp" alt="Earrings">
																	</div>
																</a>			
																<div class="product-cat-content-info">
																	<h2 class="item-title">
																		<a href="all-Jewellery.php">Earrings</a>
																	</h2>
																</div>
															</div>
														</div>
														<div class="item item-product-cat slick-slide">	
															<div class="item-product-cat-content">
																<a href="all-Jewellery.php">
																	<div class="item-image animation-horizontal">
																		<img width="258"  height="258" src="media/gold-N/gold N2.png" alt="Necklaces">
																	</div>
																</a>			
																<div class="product-cat-content-info">
																	<h2 class="item-title">
														...
														<div class="item item-product-cat slick-slide">	
															<div class="item-product-cat-content">
																<a href="all-Jewellery.php">
																	<div class="item-image animation-horizontal">
																		<img width="258" height="258" src="media/gold-R/gold R2.jpg" alt="Rings">
																	</div>
																</a>			
																<div class="product-cat-content-info">
																	<h2 class="item-title">
														...
														<div class="item item-product-cat slick-slide">	
															<div class="item-product-cat-content">
																<a href="all-Jewellery.php">
																	<div class="item-image animation-horizontal">
																		<img width="258" height="258" src="media/gold-N/gold N7.jpg" alt="Bracelets">
																	</div>
																</a>			
																<div class="product-cat-content-info">
																	<h2 class="item-title">
																		<a href="all-Jewellery.php">Bracelets</a>
																	</h2>
																</div>
															</div>
														</div>
							...
							<section class="section section-padding m-b-70">
								<div class="section-container large">
									...
									<div class="block block-products slider">
										<div class="block-widget-wrap">
											<div class="block-title"><h2>Top Products</h2></div>
											<div class="block-content">
...
<?php 
$count = 0; // counter to track number of products outputted
while ($row = $result->fetch_assoc()) { 
    if ($count >= 8) break;  // stop after 8 products

    // Construct image paths
    $mainImagePath = 'royal-carat-admin/' . $row['product_image'];
    $hoverImagePath = !empty($row['hover_image']) ? 'royal-carat-admin/' . $row['hover_image'] : $mainImagePath;
?>
                ...
                <div class="products-thumb">
                    <div class="product-thumb-hover">
                        <a href="shop-details.php?id=<?php echo $row['id']; ?>">
                            <!-- Main Image -->
                            <img width="600" height="600" src="<?php echo htmlspecialchars($mainImagePath); ?>" class="post-image" alt="Main Image">

                            <!-- Hover Image -->
                            <img width="600" height="600" src="<?php echo htmlspecialchars($hoverImagePath); ?>" class="hover-image back" alt="Hover Image">
                        </a>
                    </div>
                    <div class="product-button">
                        <div class="btn-add-to-cart" data-title="Know More">
                            <a rel="nofollow" href="shop-details.php?id=<?php echo $row['id']; ?>" class="product-btn button">Know More</a>
                        </div>
                    </div>
                </div>
...
?>
														...
														<div class="bg-banner">
															<div class="banner-wrapper banners">
																...
																<div class="banner-wrapper-infor">
																	<div class="info">
																		<div class="content">
																			<h3 class="title-banner">Coastal Edge</h3>
																			<div class="banner-image-description">
																 		 		Freshwater pearl necklace and earrings
																			</div>
																			<a class="button button-outline thick-border border-white button-arrow" href="all-Jewellery.php">Explore</a>
																		</div>
																	</div>
																</div>
															</div>
														...
														<div class="bg-banner">
															<div class="banner-wrapper banners">
																...
																<div class="banner-wrapper-infor">
																	<div class="info">
																		<div class="content">
																			<h3 class="title-banner"> Golden Grace</h3>
																			<div class="banner-image-description">
																		 		Freshwater pearl necklace and earrings
																			</div>
																			<a class="button button-outline thick-border border-white button-arrow" href="all-Jewellery.php">Explore</a>
	...
	<div class="testimonial-item">
		...
		<h2 class="testimonial-title">“Truly elegant and timeless”</h2>
		<div class="testimonial-excerpt">
			I ordered the freshwater pearl earrings for my sister’s wedding. The craftsmanship, quality, and packaging exceeded my expectations. It added a graceful charm to the traditional attire.
		</div>								
	</div>
	<div class="testimonial-image image-position-top">
		<div class="thumbnail">
			<img width="110" height="110" src="media/profile-docu.png" alt="">							
		</div>
		<div class="testimonial-info">
			<h2 class="testimonial-customer-name">Ananya Mehra</h2>
		</div>
	</div>
</div>
														</div>
														<div class="testimonial-content">
															<div class="item">
																...
																<div class="testimonial-image image-position-top">
																	...
																	<div class="testimonial-info">
																		<h2 class="testimonial-customer-name">Meera Iyer</h2>
																	</div>
																</div>
															</div>
														</div>
														<div class="testimonial-content">
															<div class="item">
																...
																<div class="testimonial-image image-position-top">
																	...
																	<div class="testimonial-info">
																		<h2 class="testimonial-customer-name">Priya Nair</h2>
																	</div>
																</div>
															</div>
														</div>
														<div class="testimonial-content">
															<div class="item">
																...
																<div class="testimonial-image image-position-top">
																	...
																	<div class="testimonial-info">
																		<h2 class="testimonial-customer-name">Kavya Sharma</h2>
																	</div>
																</div>
															</div>
														</div>
									...
									<div class="block block-newsletter layout-2 one-col">
										<div class="block-widget-wrap">
											<div class="newsletter-title-wrap">
												<h2 class="newsletter-title">Latest From Royal carat!</h2>
												<div class="newsletter-text">Sign-up to receive exculsive offer on your next purchase. Plus hear about new arrivals and offers.</div>
											</div>
						...
						<div class="section-container">
							<div class="block-widget-wrap">
								<div class="row">
									<div class="col-lg-4 col-md-6 column-1">
										<div class="block block-menu m-b-20">
											...
											<div class="block-content">
												<ul>
													<li>
														<span>Head Office:</span> Mumbai thane 
													</li>
													<li>
														<span>Tel:</span> +91 9080705678
													</li>
													<li>
														<span>Email:</span> <a href="mailto:">royalcarat@yahoo.com</a>
													</li>
												</ul>
											</div>
										</div>
									...
									<div class="col-lg-4 col-md-6 column-3">
									...
									<div class="col-lg-4 col-md-6 column-4">
										<div class="block block-menu">
