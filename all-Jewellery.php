...
if (!empty($category) && !empty($subcategory)) {
    // Filter by category_id and sub_category_id
    $sql = "SELECT * FROM product WHERE category_id = ? AND sub_category_id = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ii", $category, $subcategory); // Use "ii" for integers
} elseif (!empty($category)) {
    // Filter by category_id only
    $sql = "SELECT * FROM product WHERE category_id = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("i", $category); // Use "i" for integer
} else {
						...
						<div class="section-container">
							<div class="row">
								...
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 header-center">
									<div class="site-logo">.
										<a href="index.php">
  <img src="media/royal-carat-logo-dark.png" alt="Royal-carat || Royal Gold & Diamond"
       style="filter: brightness(0) saturate(100%) invert(16%) sepia(95%) saturate(6699%) hue-rotate(354deg) brightness(90%) contrast(115%);" />
</a>

										<!-- <a href="index.php">
											<img width="400" height="79"  src="media/logo-white.png"  alt="Royal-carat || Royal Gold & Diamond" />
										</a> -->
									</div>
								</div>
										...
										<div class="site-navigation">
											...
											<!-- <nav id="main-navigation">
												<ul id="menu-main-menu" class="menu">
													...
													<li class="level-0 menu-item menu-item-has-children">
														<a href="shop-grid-left.html"><span class="menu-item-text">All Jewellery</span></a>
														
													</li>
													<li class="level-0 menu-item menu-item-has-children">
														<a href="shop-grid-left.html"><span class="menu-item-text">Diamond</span></a>
														
													</li>
													<li class="level-0 menu-item menu-item-has-children">
														<a href="shop-grid-left.html"><span class="menu-item-text">Bullions</span></a>
														
													</li>
													<li class="level-0 menu-item menu-item-has-children">
														<a href="shop-grid-left.html"><span class="menu-item-text">Gold</span></a>
														
													</li>
													<li class="level-0 menu-item menu-item-has-children">
														<a href="shop-grid-left.html"><span class="menu-item-text">Silver</span></a>
													</li>
													<li class="level-0 menu-item menu-item-has-children"> -->
...
// Only show breadcrumb if category is set
if (isset($_GET['category'])) {
    ...
    echo '<a href="all-Jewellery.php">Shop</a>';

    if (isset($categories[$categoryId])) {
        echo ' / <a href="all-Jewellery.php?category=' . $categoryId . '">' . $categories[$categoryId] . '</a>';
    }

    if ($subcategoryId && isset($subcategories[$subcategoryId])) {
        echo ' / <span>' . $subcategories[$subcategoryId] . '</span>';
    }
...
?>
								...
								<!-- <div class="breadcrumbs">
									<a href="index.php">Home</a><span class="delimiter"></span><a href="all-Jewellery.php">Shop</a><span class="delimiter"></span>
								</div> -->
							</div>
						</div>
...
$categoryId = isset($_GET['category']) ? (int)$_GET['category'] : 1; // default or current category

// Get product count per subcategory for a given category
$countQuery = "
    SELECT s.id AS subcategory_id, s.product_name AS subcategory_name, COUNT(p.id) AS product_count
    FROM sub_category s
    LEFT JOIN product p ON p.sub_category_id = s.id AND p.category_id = $categoryId
...
<ul class="sub-menu">
    <?php foreach ($subCategories as $sub): ?>
        <li>
            <a href="all-Jewellery.php?category=<?php echo $categoryId; ?>&subcategory=<?php echo $sub['subcategory_id']; ?>">
                <span class="menu-item-text">
                    <?php echo htmlspecialchars($sub['subcategory_name']); ?>
                </span>
                <span class="count">(<?php echo $sub['product_count']; ?>)</span>
            </a>
        </li>
    <?php endforeach; ?>
</ul>
															...
															<div class="row">
																<div class="col-md-4">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="media/gold-R/gold R2.jpg" class="post-image" alt="">
																				<img width="600" height="600" src="media/gold-R/gold R5.jpg" class="hover-image back" alt="">
																			</a>
																		</div>
...
<!-- Mirrored from caketheme.com/html/mojuri/shop-grid-left.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 May 2025 05:09:47 GMT -->
</html>