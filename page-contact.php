...
<head>
		...
		<title>Contact | Royal-carat || Royal Gold & Diamond</title>
						...
						<div class="section-container">
							<div class="row">
								...
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 header-center">
									<div class="site-logo">
										<a href="index.php">
									<img width="400" height="79" src="media/royal-carat-logo.png" alt="Royal-carat || Royal Gold & Diamond" /><img width="400" height="140" src="media/royal-carat-logo-dark.png" alt="Royal-carat || Royal Gold & Diamond" />		</a>
									</div>
								</div>
    ...
    <iframe
        src="https://maps.google.com/maps?q=Mumbai%2C%20Maharashtra%2C%20India&amp;t=m&amp;z=10&amp;output=embed&amp;iwloc=near"
        aria-label="Mumbai, Maharashtra, India"
        width="600"
        height="450"
        style="border:0;"
        allowfullscreen=""
														...
														<div class="col-md-4 sm-m-b-30">
															<div class="info-item">
																...
																<div class="item-content">
																	...
																	<p>8:00am – 4:00pm Mumbai Maharashtra</p>
        ...
        <div class="block block-contact-form">
            <div class="block-widget-wrap">
                ...
                <div class="block-content">
                    <form action="contact-form-handler.php" method="post" class="contact-form" novalidate="novalidate">
                        <div class="contact-us-form">
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <label class="required">Name</label><br>
                                    <span class="form-control-wrap">
                                        <input type="text" name="name" size="40" class="form-control" aria-required="true">
                                    </span>
                                </div>
                                <div class="col-sm-12 col-md-6">
                                    <label class="required">Email</label><br>
                                    <span class="form-control-wrap">
                                        <input type="email" name="email" size="40" class="form-control" aria-required="true">
                                    </span>
                                </div>
                                <div class="col-sm-12 col-md-6">
                                    <label class="required">Contact</label><br>
                                    <span class="form-control-wrap">
                                        <input type="text" name="contact" size="40" class="form-control" aria-required="true">
                                    </span>
                                </div>
                            </div>
                            <div class="row">
...
<!-- Mirrored from caketheme.com/html/mojuri/page-contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 May 2025 05:11:41 GMT -->
</html>